	...
	return (
		<div class="mx-auto max-w-5xl space-y-16 px-4 py-12 lg:px-8">
			<div class="space-y-4">
				...
				<p>
					分からないことはAIに聞ける時代になりました。だからこの教材がお渡しするのは、
					知識そのものではなく、どの順番で進むかというロードマップと、AIへの聞き方、
					そして返ってきた答えを確かめる手段です。
					ここを離れたあとも、AIを学習パートナーにして、ひとりで学び続けられる状態を目指します。
				</p>
				{featuredBook && (
					<div class="pt-2">
