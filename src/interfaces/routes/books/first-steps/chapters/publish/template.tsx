...
- 私はプログラミングの知識がまったくなく、コマンドを打ち込む操作や Git は使えません`}
				...
				<p>
					ほかの公開先を選んでも公開はできますが、次の第7章は Cloudflare Workers
					を前提に書いています。
...
- 答えの根拠になった公式資料のページがあれば、そのURLを添えてください`}
				...
				<p>
					...
					スマートフォンからも開いて、指で遊べるかを試しておきましょう。
				</p>
				<h3>2. 公式資料で確かめる</h3>
				<p>
...
（全文）`}
				...
				<p>
					...
					次の第7章の題材です。 ここでは直さずに、そのまま先へ進んでください。
				</p>
...
ゲームをインターネットに公開して、自分のURLが手に入りました。公式資料をAIに読ませて聞く方法と、公開し直す方法も使えるようになりました。`}
				...
				<p>
					...
					この本では、ここから先が本題です。
					第7章では、手元では動くのに公開先では動かない、という問題を、自分で切り分けて直します。
				</p>
			</article>
