...
- 私の状況は、プログラミングの知識がまったくない初心者で、パソコンは{{os}}、無料で使えるものを探しています`}
				...
				<p>
					答えを読んで、使うエディタを1つ決めてください。
					迷ったら、多くの人が使っていて、困ったときに情報を見つけやすい
					<strong>Visual Studio Code</strong>
					を選べば間違いありません。
				</p>
				<p>
					決めたら、同じ会話の続きで次の文を送り、インストールしてください。
					丸かっこには、選んだエディタの名前を書きます。
				</p>
				<AskAi title="同じ会話の続きで送ってください">
					{`（選んだエディタの名前）を、{{os}}に入れる手順を教えてください。
公式サイトから入手する前提で、公式サイトのURLも添えてください。`}
				</AskAi>
				<p>
					<strong>ダウンロードは、必ずそのエディタの公式サイトから</strong>
					行います。
				...
				<p>
					ドキュメントの中に、ゲーム用のフォルダを1つ作ってください。 名前は{" "}
					<code>my-game</code> とします。
				</p>
				<p>
					この本では、フォルダやファイルの名前に
