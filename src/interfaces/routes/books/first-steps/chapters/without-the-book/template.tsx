			...
			<article class="prose">
				...
				<ul>
					<li>
						...
						（第2章）：その機能を作るのに、何が関係するのかを知りたいとき
					</li>
					<li>
						<strong>型2・部分を聞く</strong>
						（序章）：答えの中に分からない言葉が出てきたとき
					</li>
					<li>
						<strong>型3・理由を聞く</strong>
						（第3章）：作り方がいくつかあって、どれにするか決めたいとき
					</li>
					<li>
						<strong>公式資料を参照させる型</strong>
						（第6章）：答えが正しいか、古くないかを確かめたいとき
					</li>
					<li>
						<strong>エラー相談の型</strong>
						（第4章）と<strong>切り分けの手順</strong>
						（第7章）：動かないとき
					</li>
					<li>
						<strong>my-game-backup</strong>
						（第4章）：大きく変える前と、うまく動いたとき
					</li>
					<li>
						<strong>公開し直すやり方</strong>（第6章）：手元で動いたあと
					</li>
				</ul>
				<p>
					ブラウザが持っている機能については、
...
- つまずいたところと、どう抜け出したか：（一言で）`}
				...
				<p>
					...
					最後の第9章では、この本のあとに何を学ぶかを、自分で決めます。
				</p>
			</article>
