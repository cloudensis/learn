...
公式サイトから入手する前提で、公式サイトのURLも添えてください。`}
				...
				<p>
					第1章で作ったゲームは、1つのHTMLファイルに全部が入っています。
					このままでも動きますが、見た目（CSS）と動き（JavaScript）を別のファイルに分けておくと、あとで直したい場所を探しやすくなります。
				</p>
				<p>
					<strong>第1章でゲームを作った会話</strong>
					を開いて、その続きで次の文を送ってください。
				</p>
				<AskAi title="第1章でゲームを作った会話の続きで送ってください">
				...
				<Troubleshoot
					items={[
						...
						},
						{
							...
							action:
								"style.css か script.js が読み込めていない可能性があります。3つのファイルが同じフォルダにあるか、ファイル名が1文字も違わないかを確かめてください。それでも直らなければ、第4章で扱うエラーの見方が役に立ちます。いったん先に進んでもかまいません。",
						},
						{
